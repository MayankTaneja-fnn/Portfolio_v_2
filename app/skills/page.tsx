...
export default function Skills() {
  const skills = [
    ...
    { name: "Python", icon: Code, level: 85, category: "Programming Languages", color: "from-green-400 to-green-600" },
    { name: "Java", icon: Code, level: 80, category: "Programming Languages", color: "from-orange-500 to-orange-700" },
    { name: "C", icon: Code, level: 85, category: "Programming Languages", color: "from-gray-500 to-gray-700" },
    {
      name: "SQL",
      icon: Database,
      level: 75,
    ...
    { name: "Next.js", icon: Code, level: 85, category: "Frameworks & Libraries", color: "from-gray-400 to-gray-600" },
    {
      name: "React Native",
      icon: Code,
      level: 80,
    ...
    { name: "NumPy", icon: Cpu, level: 75, category: "Frameworks & Libraries", color: "from-blue-500 to-blue-700" },
    {
      name: "Scikit-Learn",
      icon: Brain,
      level: 70,
    ...
    { name: "Figma", icon: Palette, level: 70, category: "Tools & Technologies", color: "from-pink-400 to-pink-600" },
    {
